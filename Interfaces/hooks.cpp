...
void PrintInfo()
{
    pCvar->ConsoleColorPrintf(Color::White(), "[skeetformac] Press ");
    ...
    pCvar->ConsoleColorPrintf(Color::Pink(), "[skeetformac] Discord Link: https://discord.gg/5A38qTt\n");
    pCvar->ConsoleColorPrintf(Color::White(), "[skeetformac] Free Mac HvH Cheat pasted by quake\n");
    pCvar->ConsoleColorPrintf(Color::Pink(), "//TY shadynurofen for the help\n");
    pCvar->ConsoleColorPrintf(Color::White(), "[skeetformac] Best Free Paste");
    pCvar->ConsoleColorPrintf(Color::Pink(), "[skeetformac] Tap them for me ;-)\n");

    ...
    if(panel == last)
    {
        ...
        //draw->drawstring(10, 15, Color::White(), espfont, "[-zeX Priv]");
           ...
           /* static int Tick = 0;
            ...
            if (Tick > 0 && Tick < 30)
            {
                draw->drawstring(10, 15, Color::Red(), espfont, "[-Breathless]");
            }
            else if (Tick > 30 && Tick < 60)
            {
                draw->drawstring(10, 15, Color::Orange(), espfont, "[-Breathless]");
            }
            else if (Tick > 60 && Tick < 90)
            {
               draw->drawstring(10, 15, Color::Yellow(), espfont, "[-Breathless]");
            }
            else if (Tick > 90 && Tick < 120)
            {
                draw->drawstring(10, 15, Color::Green(), espfont, "[-Breathless]");
            }
            else if (Tick > 120 && Tick < 150)
            {
               draw->drawstring(10, 15, Color::LightBlue(), espfont, "[-Breathless]");
            }
            else if (Tick > 150 && Tick < 180)
            {
                draw->drawstring(10, 15, Color::Purple(), espfont, "[-Breathless]");
            }
            else if (Tick > 180 && Tick < 210)
            {
               draw->drawstring(10, 15, Color::Pink(), espfont, "[-Breathless]");
            }
        ...
        if(vars.misc.watermark)
        {
            ...
            {
                draw->drawstring(10, 15, Color::White(), espfont, "-S");
            }
            else if (Tick > 150 && Tick < 180)
            {
                draw->drawstring(10, 15, Color::White(), espfont, "-S|");
            ...
            {
                draw->drawstring(10, 15, Color::White(), espfont, "-Sk");
            }
            ...
            {
                draw->drawstring(10, 15, Color::White(), espfont, "-Ske");
            }
            ...
            {
                draw->drawstring(10, 15, Color::White(), espfont, "-Skee");
            }
            ...
            {
                draw->drawstring(10, 15, Color::White(), espfont, "-Skeet");
            }
            ...
            {
                draw->drawstring(10, 15, Color::White(), espfont, "-Skeet.c");
            }
            ...
            {
                draw->drawstring(10, 15, Color::White(), espfont, "-Skeet.cc");
            }
            ...
            //
                ...
                {
                    draw->drawstring(10, 15, Color::White(), espfont, "-H");
                }
